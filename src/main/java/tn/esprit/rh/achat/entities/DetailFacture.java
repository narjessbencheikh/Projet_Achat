...
public class DetailFacture implements Serializable {
	...
	protected DetailFacture(Long idDetailFacture, Integer qteCommandee, float prixTotalDetail,
			Integer pourcentageRemise, float montantRemise, Produit produit, Facture facture) {
		super();
		this.idDetailFacture = idDetailFacture;
		this.qteCommandee = qteCommandee;
		this.prixTotalDetail = prixTotalDetail;
